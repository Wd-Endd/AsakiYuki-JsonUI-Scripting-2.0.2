...
export interface JsonUIProperty extends AnyPropertyInterface, ButtonInterface, CollectionInterface, ChildCollectionInterface, DropdownInterface, FocusInterface, GirdInterface, InputInterface, LayoutInterface, RendererInterface, ScreenInterface, ScrollViewInterface, SelectionWheelInterface, ScreenInterface, SliderInterface, SliderBoxInterface, SoundInterface, SpecialInterface, SpriteInterface, StackPanelInterface, TextInterface, TextEditInterface, ToggleInterface, TTSInterface, ChildCollectionInterface, ControlInterface {
