 ...
 * ```
 */
export declare function objectForEach(data: object, callback: (value: any, key: string) => void): void;
export declare function objectMap(data: object, callback: (value: any, key: string) => any): object;
