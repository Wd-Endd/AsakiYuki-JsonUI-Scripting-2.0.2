...
exports.JsonUILib = void 0;
class JsonUILib {
    static floatToIntBindingsBuild(binding_name, binding_name_override, max_int, checkNegative = false) {
        try {
            if (max_int >= 10000000000)
                throw "Max int should lower 10000000000";
            const l = `${max_int}`.length, _ = [];
            let i = l, $ = [], e = binding_name;
            if (checkNegative) {
                _.push({
                    binding_type: "view",
